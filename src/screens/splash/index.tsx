...
import { ImageBackground, StyleSheet, View, Text, Image, Alert } from "react-native";
...
export const SplashScreen = ({ navigation }: { navigation: any }) => {
    ...
    return (
        <View style={Style.container}>
            <ImageBackground style={Style.splashbackground} source={Assets.splash_background}>
...
const Style = StyleSheet.create({
    ...
    bluebox: { height: 100, width: 100, backgroundColor: Colors.splash_blue, borderRadius: 20, flexDirection: 'row', justifyContent: 'center' },
